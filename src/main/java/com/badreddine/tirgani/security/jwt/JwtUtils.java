...
import com.badreddine.tirgani.security.services.UserDetailsImpl;
...
public class JwtUtils {
    ...
    @Value("${tirgani.app.jwtSecret}")
    private String jwtSecret;

    @Value("${tirgani.app.EXPIRE_ACCESS_TOKEN}")
    private int EXPIRE_ACCESS_TOKEN;

    @Value("${tirgani.app.EXPIRE_REFRESH_TOKEN}")
    private int EXPIRE_REFRESH_TOKEN;

    @Value("${tirgani.app.jwtCookieName}")
